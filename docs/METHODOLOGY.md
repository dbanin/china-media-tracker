...
Generated 2026-09-21T01:50:45+00:00. Ruleset version 2026.09.7. Schema version 6.
...
At export time 1026 such candidates were waiting across 98
countries.
...
Unverified relay. Written by the local outlet but passes on official Chinese sourcing without independent confirmation.
...
State origin labels by route, all time: wire credit line or dateline 263; press release distribution stamp 97; sponsored or partner disclosure 50; signed by a chinese diplomat 5; no signature; model judgement 243.
...
| Articles discovered | 1212519 |
| Articles passing the relevance gate | 37126 |
| Articles classified | 29208 |
...
| State origin, all time | 658 |
| Unverified relay, all time | 934 (provisional) |
| Independent journalism, all time | 14500 |
...
| Feed polls that returned a full window with nothing seen before | 3336 of 102453 polls, an estimated 90614 items missed |
| Relay collector on the owner's machine | 54 outlets; last pass 2026-09-21T01:08:15+00:00 (0.7 hours before export); 10 incomplete days |
| Current labels by ruleset version | 2026.09.2: 94, 2026.09.7: 29114 (reclassification under 2026.09.7 in progress) |
| Last successful run | 2026-09-21T01:50:45+00:00 |
...
Unverified relay counts are shown as provisional: they are one model's judgement and nothing has checked them yet. Every figure that contains them is marked provisional in the interface and carries relay_status provisional in the CSV export. A reliability study is queued and runs by itself once the monthly model budget allows, not before 2026-10-01. Provisional means not checked yet, never checked and failed: once a study reports, the counts are published if kappa on the unverified relay versus independent journalism distinction is at least 0.6 and withheld if it is not. Before a study there is no per language result, so no language is withheld.
