...
Generated 2026-09-15T07:40:50+00:00. Ruleset version 2026.09.5. Schema version 4.
...
At export time 2666 such candidates were waiting across 149
countries.
...
| Articles discovered | 758175 |
| Articles passing the relevance gate | 20549 |
| Articles classified | 13573 |
| Articles with a human review | 0 (0.0 percent of classified) |
| Share of gated articles that were paywalled | 9.0 percent |
| Countries flagged as not comparable because of paywalls | CAN, CHE, CRI, ESP, FIN, HKG, IRL, JPN, NOR, SWE, URY |
| State origin, all time | 211 |
| Unverified relay, all time | 0 |
| Independent journalism, all time | 8248 |
| Language model calls, all time | 0 |
| Days on which the model call ceiling (600) was hit | none |
| Last successful run | 2026-09-15T07:40:50+00:00 |
...
(World Bank, SP.POP.TOTL, 2024, retrieved 2026-09-06 from api.worldbank.org; UN World Population Prospects 2024 and territorial statistics offices, approximate). The share of all published items divides target
...
concerns China. The largest outlets are the 30 best audience ranks
recorded in sources/outlets.yaml; no outlet carries a rank yet, so every active outlet in a country counts, and the metric measures the monitored set rather than the thirty largest publications.
...
(pipeline/themes.yaml, themes version 2026.09.3): diplomacy and summits,
