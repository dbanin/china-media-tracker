...
Generated 2026-09-16T01:10:22+00:00. Ruleset version 2026.09.7. Schema version 5.
...
At most 600 model calls are made a day. When more articles are
...
At export time 3429 such candidates were waiting across 150
countries.
...
State origin labels by route, all time: wire credit line or dateline 163; press release distribution stamp 66; sponsored or partner disclosure 9; signed by a chinese diplomat 4; no signature; model judgement 13.
...
| Articles discovered | 830789 |
| Articles passing the relevance gate | 24761 |
| Articles classified | 16452 |
...
| State origin, all time | 255 |
| Unverified relay, all time | withheld |
| Independent journalism, all time | 9050 |
| Language model calls, all time | 279 |
| Days on which the model call ceiling (600) was hit | 2026-09-16 |
| Feed polls that returned a full window with nothing seen before | 61 of 11447 polls, an estimated 315 items missed |
| Relay collector on the owner's machine | 54 outlets; last pass 2026-09-15T23:36:38+00:00 (1.6 hours before export); 5 incomplete days |
| Current labels by ruleset version | 2026.09.2: 94, 2026.09.3: 82, 2026.09.4: 3233, 2026.09.5: 7129, 2026.09.6: 125, 2026.09.7: 5789 (reclassification under 2026.09.7 in progress) |
| Last successful run | 2026-09-16T01:10:22+00:00 |

## Agreement and what may be published

No agreement study has been completed yet. Run pipeline/agreement.py to draw a sample, hand code it, and compute kappa.

Unverified relay counts are withheld from the interface and the CSV export, not merely annotated, until an agreement study gives kappa on the unverified relay versus independent journalism distinction of at least 0.6. That boundary is where classification error concentrates.
